...
2. Публиковать APK как **GitHub Release Asset** (например, `monitoring-android.apk`).
   - Актуальный prerelease APK: <!-- ANDROID_PRERELEASE_APK_LINK_START -->https://github.com/<org>/<repo>/releases/download/v8.32.56-develop/monitoring-android-8.32.56-develop.apk<!-- ANDROID_PRERELEASE_APK_LINK_END -->
