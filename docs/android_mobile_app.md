...
2. Публиковать APK как **GitHub Release Asset** (например, `monitoring-android.apk`).
   - Актуальный prerelease APK: <!-- ANDROID_PRERELEASE_APK_LINK_START -->https://github.com/sukhanovai/monitoring/releases/download/v8.33.26-develop/monitoring-android-8.33.26-develop-debug.apk<!-- ANDROID_PRERELEASE_APK_LINK_END -->
