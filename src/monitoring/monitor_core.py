...
from monitoring.lib.alerts import (
...
from monitoring.config.db_settings import DEBUG_MODE, DATA_DIR
from monitoring.core.monitor import monitor
from monitoring.modules.availability import availability_checker
from monitoring.modules.resources import resources_checker
from monitoring.modules.morning_report import morning_report
...
from monitoring.lib.utils import safe_import
from monitoring.extensions.server_checks import check_server_availability
...
get_check_interval = lazy_import('monitoring.config.db_settings', 'CHECK_INTERVAL')
get_silent_times = lazy_import('monitoring.config.db_settings', 'SILENT_START')
get_data_collection_time = lazy_import('monitoring.config.db_settings', 'DATA_COLLECTION_TIME')
get_max_fail_time = lazy_import('monitoring.config.db_settings', 'MAX_FAIL_TIME')
get_resource_config = lazy_import('monitoring.config.db_settings', 'RESOURCE_CHECK_INTERVAL')
...
def perform_manual_check(context, chat_id, progress_message_id):
    ...
    global servers
    if not servers:
        from monitoring.extensions.server_checks import initialize_servers
