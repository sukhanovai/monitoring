...
def settings_command(update, context):
    ...
    keyboard.append([InlineKeyboardButton("🔔 Мои оповещения", callback_data="settings_my_alerts")])
    keyboard.append([InlineKeyboardButton("👥 Пользователи", callback_data="settings_users")])
