...
### Changed / Изменено
- EN: Completed repository-wide patch version bump to `8.32.71`; Android metadata updated to `ANDROID_VERSION_NAME=8.32.71`, `ANDROID_VERSION_CODE=116`.
- RU: Выполнен полный патч-бамп версии по репозиторию до `8.32.71`; Android-метаданные обновлены до `ANDROID_VERSION_NAME=8.32.71`, `ANDROID_VERSION_CODE=116`.
