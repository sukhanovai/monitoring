...
## [8.33.30] - 2026-03-19
- EN: Follow-up version sync: completed repository-wide patch bump to `8.33.30` and aligned Android metadata to `ANDROID_VERSION_NAME=8.33.30`, `ANDROID_VERSION_CODE=149`.
- RU: Доводочный синк версий: выполнен полный патч-бамп по репозиторию до `8.33.30`, Android-метаданные выровнены до `ANDROID_VERSION_NAME=8.33.30`, `ANDROID_VERSION_CODE=149`.
