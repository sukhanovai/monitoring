"""
/config/settings.py
Server Monitoring System v8.32.71
...
# Версия приложения
APP_VERSION = "8.32.71"
ANDROID_APP_VERSION = "8.32.71"
ANDROID_MIN_SUPPORTED_VERSION = "8.32.71"
ANDROID_LATEST_VERSION = "8.32.71"
ANDROID_APK_DOWNLOAD_URL = os.environ.get(
    "ANDROID_APK_DOWNLOAD_URL",
    "https://github.com/sukhanovai/monitoring/releases/latest/download/monitoring-android.apk",
)
