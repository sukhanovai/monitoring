...
data class SettingsMonitoringRequest(
    ...
    @Json(name = "windows_2025_timeout") val windows2025Timeout: Int? = null,
    @Json(name = "domain_servers_timeout") val domainServersTimeout: Int? = null,
    @Json(name = "admin_servers_timeout") val adminServersTimeout: Int? = null,
    @Json(name = "standard_windows_timeout") val standardWindowsTimeout: Int? = null,
    @Json(name = "linux_timeout") val linuxTimeout: Int? = null,
    @Json(name = "ping_timeout") val pingTimeout: Int? = null
)
